...
HRESULT CD3DFont::CreateGDIFont(HDC hDC, HFONT* pFont)
{
	...
	*pFont         = CreateFont(nHeight, 0, 0, 0, dwBold, dwItalic,
								...
								CLIP_DEFAULT_PRECIS, (m_dwFontFlags & D3DFONT_ANTIALIASED) ? ANTIALIASED_QUALITY : NONANTIALIASED_QUALITY,
...
//-----------------------------------------------------------------------------
HRESULT CD3DFont::InitDeviceObjects(IDirect3DDevice9* pd3dDevice)
{
	HRESULT hr = S_OK;
	HFONT hFont = NULL;
	HFONT hFontOld = NULL;
