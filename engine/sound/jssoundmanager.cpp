...
namespace sound
{
	...
	static JSFunctionSpec class_methods[] =
	{
		...
		JS_FN("getSound", WRAP_FASTNATIVE(SoundManager::getSound), 1, 0),
		JS_FN("playSound", WRAP_FASTNATIVE(SoundManager::playSound), 2, 0),
		JS_FN("playSound3d", WRAP_FASTNATIVE(SoundManager::playSound3d), 3, 0),
		JS_FS_END
	};
