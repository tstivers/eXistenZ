...
#define JS_EXTERN_API(__type) extern __declspec(dllexport) __type __cdecl
#define JS_EXPORT_API(__type) __declspec(dllexport) __type __cdecl
#define JS_EXTERN_DATA(__type) extern __declspec(dllexport) __type __cdecl
#define JS_EXPORT_DATA(__type) __declspec(dllexport) __type __cdecl
